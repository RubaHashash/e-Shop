...
class OrderChart extends StatelessWidget {
  final orderChartdisplay;

  const OrderChart({Key key, this.orderChartdisplay}) : super(key: key);
          ...
          child: Container(
            ...
            child: Column(
              children: [
                SizedBox(height: 10),
                Center(
                  child: Text("Orders for Year 2021", style: TextStyle(color: Palette.darkBlue, fontSize: 20, fontWeight: FontWeight.bold),),
                ),
                SizedBox(height: 40),
                Container(
                  height: 380,
